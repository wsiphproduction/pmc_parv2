            ...
            <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h6>From : <?php if($par[0]['is_dept'] == 1): ?> <?php echo e($sender['dept_id']); ?> <?php else: ?> <?php echo e($sender['employee_id']); ?> <?php echo e($sender['accountable']); ?> <?php endif; ?></h6>
                        
                        <h6>Reason : <?php echo e($par[0]['reason']); ?></h6>
                        <h6>Date and Time Transfered : <?php echo e($par[0]['date_transfer']); ?></h6>
            ...
            <div class="col-sm-6 col-lg-4 mg-sm-t-20">
                ...
                <ul class="list-unstyled lh-7">
                    ...
                    <li>
                        ...
                        <span><?php echo e($par[0]['ref_par']); ?></span>
                    </li>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $par; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($par_header->serial_no); ?></td>
