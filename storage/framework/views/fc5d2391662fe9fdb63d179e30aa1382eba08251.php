                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                                    ...
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="tx-12">
                                            ...
                                            <td>
                                                ...
                                                <a href="#item-delete" data-toggle="modal" data-id="<?php echo e($item->id); ?>" title="Delete Item" class="btn btn-xs btn-danger btn-sm delete-item">
                            ...
                            <div class="d-flex flex-row justify-content-between mg-t-20">
                                <div class="pd-10">Total of <?php echo e($items->total()); ?> stock items</div>
                                <div class="pd-10">&nbsp;</div>
