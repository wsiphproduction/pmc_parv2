...
<link href="<?php echo e(asset('assets/lib/jqvmap/jqvmap.min.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
    <div>
        <h4 class="mg-b-0 tx-spacing--1">Hello! <?php echo e(Auth::user()->fullName); ?>, welcome to Par v2 </h4>
    </div>
</div>
