        ...
        <div class="aside-loggedin">
            ...
            <div class="aside-loggedin-user">
                <a href="#loggedinMenu" class="d-flex align-items-center justify-content-between mg-b-2" data-toggle="collapse">
                    <h6 class="tx-semibold mg-b-0 tx-white"><?php echo e(Auth::user()->fullName); ?></h6>
                </a>
                <p class="tx-color-03 tx-12 mg-b-0 tx-uppercase"><?php echo e(Auth::user()->role); ?></p>
            </div>
        </div><!-- aside-loggedin -->
        <ul class="nav nav-aside">
                <li class="nav-label">Menus</li>
            <?php if(Auth::user()->role == 'read only' || Auth::user()->is_dept == 1): ?>
