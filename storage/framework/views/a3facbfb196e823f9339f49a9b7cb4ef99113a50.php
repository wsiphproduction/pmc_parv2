                ...
                <div class="card-body">
                    ...
                    <div class="form-row mg-b-15">
                        <div class="col-md-8" id="empdiv">
                            ...
                            <select required class="custom-select" name="item_kind" id="item_kind">
                                <option <?php if(!isset($stock)): ?> disabled <?php endif; ?> value="1">Stock Item w/ Serial</option>
                                <option <?php if(isset($stock)): ?> disabled <?php else: ?> selected <?php endif; ?> value="2">Non-stock Item</option>
                                <option <?php if(!isset($stock)): ?> disabled <?php endif; ?> value="3">Stock Items w/out Serial</option>
                            </select>
                        </div>
                        <?php if(isset($stock)): ?>
                        <div class="col-md-4 stock_code">
                            <label for="department">Stock Code</label>
                            <input type="text" name="stock_code" id="stock_code" class="form-control stock" readonly value="<?php echo e($stock->stock_code); ?>">
                    ...
                    <div class="form-row mg-b-20">
                        <div class="col-md-12">
                            ...
                            <textarea required class="form-control" rows="2" id="desc" name="desc" placeholder="Enter item description here . . ." <?php if(isset($stock)): ?> readonly <?php endif; ?> ><?php if(isset($stock)): ?> <?php echo e($stock->description); ?> <?php endif; ?></textarea>
                        </div>
                    </div> 
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if(isset($stock)): ?>
                                <div class="uom_static">
                                    <input type="text" name="uom_input" id="uom" class="form-control" readonly value="<?php echo e($stock->uom); ?>">
                                </div>
                            <?php else: ?>
                                <div>
                    ...
                    <div class="form-row mg-b-20">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="oem_id" id="oem" class="form-control" placeholder="Enter OEM Id" <?php if(isset($stock)): ?> readonly value="<?php echo e($stock->oem_id); ?>" <?php endif; ?>>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-row mg-b-15">
                        <?php if(isset($stock)): ?>
                            <div class="col-md-4 inv_code">
                                ...
                                <input type="text" name="i_inv_code" class="form-control" id="inv" readonly value="<?php echo e($stock->inv_code); ?>">
                            </div>
                            <div class="col-md-4 stock_type">
                                <label for="Stock">Stock Type</label>
                                <input type="text" name="stock_type" id="stype" class="form-control" readonly value="<?php echo e($stock->stock_type); ?>">
                            </div>
                        <?php endif; ?>
                        <div class="col-md-4">
        ...
        if(a.length >= 3){
            ...
            $("input[name='serial[]']").each(function(){
                ...
                if(arr.indexOf(value) < 0){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('serial.check')); ?>",
                        method: "POST",
                        data: { serial: a,
                                inp_no: b,
                                _token:_token 
