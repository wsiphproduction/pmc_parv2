...
<div class="d-sm-flex align-items-center justify-content-between mg-b-10 mg-lg-b-25 mg-xl-b-10">
    ...
    <form autocomplete="off" role="form" action="/par/update" method="POST" id="selectForm2" class="parsley-style-1" data-parsley-validate novalidate>
        <?php echo csrf_field(); ?>
        <div class="row row-xs">
            <div class="col-lg-12 mg-t-10">
                <div class="card">
                    <div class="card-body">
                        <input type="hidden" id="total_items" name="total_items" value="<?php echo e($count_items); ?>">
                        ...
                        <div class="form-group row">                            
                            ...
                            <div class="col-sm-4">
                                <select class="form-control select2-no-search" name="site" <?php if($par->p_location=='davao'): ?> disabled <?php else: ?> required <?php endif; ?>>
                                    <option value="">Select One</option>
                            ...
                            <div class="col-sm-3">
                                <input required type="text" id="po_no" name="po_no" value="<?php echo e($par->po_no); ?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">                            
                            ...
                            <div class="col-sm-4">
                                <input required type="text" name="serial_no" id="serial_no" value="<?php echo e($par->serial_no); ?>" class="form-control">
                            </div>

                            <label for="inputEmail3" class="col-sm-3 col-form-label d-flex justify-content-end">CIS/S.I # <i class="tx-danger">*</i></label>
                            <div class="col-sm-3">
                                <input required type="text" id="cis_si_no" name="cis_si_no" value="<?php echo e($par->cis_si_no); ?>" class="form-control">
                            </div>
                        </div>
                                            ...
                                            <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr id="tr<?php echo e($i->item_id); ?>">
                                                        ...
                                                        <td class="wd-10p"><?php echo e($i->stock_code); ?></td>
                                                        <td class="wd-30p"><?php echo e($i->description); ?></td>
                                                        <td class="wd-8p"><?php echo e($i->serial_no); ?></td>
                                                        <td class="wd-8p"><input type="text" <?php if($i->serial_no != ''): ?> readonly <?php endif; ?> name="qty[]" value="<?php echo e($i->qty); ?>" class="form-control input-xs text-right"></td>
                                                        <td class="wd-10p"><?php echo e($i->uom); ?></td>
                                                        <td class="wd-10p"><input type="text" readonly name="cost[]" class="form-control input-xs text-right" value="<?php echo e($i->cost); ?>"></td>        
                                                        <td class="wd-2p"><a class="btn btn-danger btn-sm item_delete" data-did="<?php echo e($i->details_id); ?>" data-toggle="modal" href="#close-par-item"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
    ...
    <div class="modal effect-scale" id="close-par-item" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="/par-item/delete" method="post" role="form">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <input type="hidden" id="details_id" name="id">
                        <p>Please state your reason for deleting this transaction. <i class="text-danger">*</i></p>
...
<?php $__env->startSection('pagejs'); ?>
    ...
    <script>
        ...
        $(document).on('click','.item_delete',function(){
            $(".modal-body #details_id").val($(this).data('did'));
        });
        ...
        $(document).ready(function(){
            ...
            function doneTypingDepartment(){
                ...
                var _token = $('input[name="_token"]').val();
                $.ajax({
                    url: "<?php echo e(route('api.department.fetch')); ?>",
                    method: "POST",
                    data: { query :query, _token:_token },
                    success: function(data)
                    {
