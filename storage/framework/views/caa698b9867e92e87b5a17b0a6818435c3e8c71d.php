                ...
                <div class="modal-body pd-sm-t-30 pd-sm-b-40 pd-sm-x-30">
                    ...
                    <div class="form-group">
                        <select required class="form-control" name="close_type" >
                            ...
                            <?php $__currentLoopData = $close_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($c->description); ?>"><?php echo e($c->description); ?></option>
