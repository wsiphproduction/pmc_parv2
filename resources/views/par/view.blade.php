            ...
            <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h6>From : @if($par[0]['is_dept'] == 1) {{ $sender['dept_id'] }} @else {{ $sender['employee_id'] }} {{ $sender['accountable'] }} @endif</h6>
                        {{-- <h6 class="tx-15">
                        </h6> --}}
                        <h6>Reason : {{ $par[0]['reason'] }}</h6>
                        <h6>Date and Time Transfered : {{ $par[0]['date_transfer'] }}</h6>
