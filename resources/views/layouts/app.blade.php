...
<head>
    ...
    <link rel="stylesheet" id="dfMode" href="{{ asset('assets/css/skin.light.css') }}">
    <link rel="stylesheet" id="dfSkin" href="{{ asset('assets/css/skin.deepblue.css') }}">
    ...
    <div class="content ht-100v pd-0">
        <div class="content-header">
            <div class="content-search content-company wd-400">
                <h3 class="tx-15 mg-b-0 dept_header" style="color:#fbeaeb;">{{ Auth::user()->dept != '' ? Auth::user()->dept : 'Material Control Department' }} </h3>
            </div>
        </div>
                        ...
                        <div class="d-sm-flex">
                            ...
                            <div class="flex-fill">
                                ...
                                <div class="form-group mg-b-10">
                                    ...
                                    <input readonly type="text" class="form-control" value="{{ Auth::user()->fullName }}">
                                </div>

                                <h6 class="mg-t-20 mg-b-10">Contact Information</h6>

                                <div class="form-group mg-b-10">
                                    <input readonly type="text" name="domain" class="form-control" value="{{ Auth::user()->domainAccount }}">
                                </div><!-- form-group -->
                                <div class="form-group mg-b-10">
                                    <input type="email" name="email" class="form-control" placeholder="Enter Email Address" value="{{ Auth::user()->email }}">
                                </div><!-- form-group -->
            ...
            <div class="modal-content">
                ...
                <form action="/upload/avatar" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="id" value="{{ Auth::user()->id }}">
                        <input type="hidden" name="domain" class="form-control" value="{{ Auth::user()->domainAccount }}">
