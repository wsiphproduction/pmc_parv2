                                                    ...
                                                    <td colspan='6'>
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" onkeyup="itemSearch($(this).val(),{{$i->id}})" id="item_search_{{$i->id}}" class="form-control" placeholder="Search item description or Stock Code...">
                                                           ...
                                                           <div class="col-md-2">
                                                                <input type="number" class="form-control" name="stockcode[]" id="stockcode_{{$i->id}}" placeholder="Stock Code">
                                                            </div>
                                                            <div class="col-md-3">
